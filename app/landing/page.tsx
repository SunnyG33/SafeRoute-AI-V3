...
const HeroModeRedesigned = ({ onExit }: { onExit: () => void }) => (
  <div className="p-8 text-white">
    <h2>Hero Mode (Component Loading...)</h2>
    <Button onClick={onExit}>Exit</Button>
  </div>
)

const UniversalNavigation = ({ showBackButton, showNextPrevious }: any) => (
  <div className="h-12 bg-slate-800 flex items-center px-4">
    <span className="text-white">SafeRoute AI Navigation</span>
  </div>
)
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-green-400 mb-4"></div>
          <h2 className="text-2xl font-bold bg-gradient-to-r from-white via-green-200 to-emerald-200 bg-clip-text text-transparent mb-2">
            SafeRoute AI
          </h2>
          <p className="text-green-200">Loading emergency response platform...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <section className="relative overflow-hidden z-10 min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="relative container mx-auto px-4 py-8 min-h-screen flex items-center justify-center">
          {/* Top Left Corner - Elder Portal */}
          <div className="absolute top-24 left-16 z-20">
            <Link href="/elder-portal">
              <Button
                size="lg"
                className="bg-gradient-to-r from-amber-600 via-orange-600 to-yellow-600 hover:from-amber-700 hover:via-orange-700 hover:to-yellow-700 text-white px-6 py-3 shadow-lg backdrop-blur-sm border border-amber-600/30 text-sm font-bold"
              >
          ...
          {/* Top Right Corner - Responder Portal */}
          <div className="absolute top-24 right-16 z-20">
            <Link href="/responder-portal-hero">
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-800 via-purple-700 to-purple-600 hover:from-purple-900 hover:via-purple-800 hover:to-purple-700 text-white px-6 py-3 shadow-lg backdrop-blur-sm border border-purple-600/30 text-sm font-bold"
              >
          ...
          {/* Bottom Left Corner - Community Portal */}
          <div className="absolute bottom-24 left-16 z-20">
            <Link href="/community-portal">
              <Button
                size="lg"
                className="bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white px-6 py-3 shadow-lg backdrop-blur-sm border border-teal-600/30 text-sm font-bold"
              >
          ...
          {/* Bottom Right Corner - Government Portal */}
          <div className="absolute bottom-24 right-16 z-20">
            <Link href="/government-dashboard">
              <Button
                size="lg"
                className="bg-gradient-to-r from-slate-100 via-blue-100 to-white hover:from-slate-200 hover:via-blue-200 hover:to-gray-100 text-slate-800 px-6 py-3 shadow-lg backdrop-blur-sm border border-slate-300/50 text-sm font-bold"
              >
          ...
          <div className="text-center max-w-6xl mx-auto relative">
            {/* SafeRoute AI Logo with Inuksuk */}
            <div className="flex items-center justify-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center mr-6 shadow-2xl">
                <svg className="w-12 h-12" viewBox="0 0 100 100" fill="none">
                  {/* Circular border */}
                  <circle cx="50" cy="50" r="48" stroke="white" strokeWidth="4" fill="none" />

                  {/* Realistic Inuksuk with stone textures and reddish-brown coloring */}
                  {/* Head stone */}
                  <path d="M45 15 L55 15 L57 25 L43 25 Z" fill="#8B4513" stroke="#654321" strokeWidth="0.5" />

                  {/* Top horizontal arm stones */}
                  <path d="M25 30 L75 30 L73 38 L27 38 Z" fill="#A0522D" stroke="#654321" strokeWidth="0.5" />

                  {/* Upper body stones */}
                  <path d="M42 40 L58 40 L56 48 L44 48 Z" fill="#8B4513" stroke="#654321" strokeWidth="0.5" />
                  <path d="M44 50 L56 50 L54 58 L46 58 Z" fill="#A0522D" stroke="#654321" strokeWidth="0.5" />

                  {/* Middle horizontal arm stones */}
                  <path d="M20 52 L35 52 L33 60 L22 60 Z" fill="#8B4513" stroke="#654321" strokeWidth="0.5" />
                  <path d="M65 52 L80 52 L78 60 L67 60 Z" fill="#8B4513" stroke="#654321" strokeWidth="0.5" />

                  {/* Lower body stones */}
                  <path d="M43 62 L57 62 L55 70 L45 70 Z" fill="#A0522D" stroke="#654321" strokeWidth="0.5" />
                  <path d="M44 72 L56 72 L54 78 L46 78 Z" fill="#8B4513" stroke="#654321" strokeWidth="0.5" />

                  {/* Base leg stones */}
                  <path d="M35 75 L45 75 L43 85 L37 85 Z" fill="#A0522D" stroke="#654321" strokeWidth="0.5" />
                  <path d="M55 75 L65 75 L63 85 L57 85 Z" fill="#A0522D" stroke="#654321" strokeWidth="0.5" />

                  {/* Stone texture details */}
                  <circle cx="50" cy="20" r="1" fill="#654321" opacity="0.6" />
                  <circle cx="50" cy="35" r="1" fill="#654321" opacity="0.6" />
                  <circle cx="50" cy="45" r="1" fill="#654321" opacity="0.6" />
                  <circle cx="50" cy="55" r="1" fill="#654321" opacity="0.6" />
                  <circle cx="50" cy="67" r="1" fill="#654321" opacity="0.6" />
                  <circle cx="41" cy="80" r="1" fill="#654321" opacity="0.6" />
                  <circle cx="59" cy="80" r="1" fill="#654321" opacity="0.6" />
                </svg>
              </div>
              <div className="text-left">
                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 via-emerald-400 to-green-300 bg-clip-text text-transparent mb-2 tracking-tight">
                  SafeRoute AI
                </h1>
                <p className="text-lg md:text-xl text-green-300 font-medium">Emergency Response Infrastructure</p>
              </div>
            </div>

            {/* Main Description */}
            <div className="mb-6">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">SafeRoute AI is the world's first</h2>
              <p className="text-xl md:text-2xl mb-2 bg-gradient-to-r from-white via-green-200 to-green-400 bg-clip-text text-transparent font-bold">
                offline-capable, Indigenous-led, modular ecosystem
              </p>
              <p className="text-lg text-gray-300 mb-6">
                revolutionizing emergency response, disaster relief, and public safety infrastructure for a connected
                world.
              </p>
            </div>

            {/* Central Civilian Portal Button */}
            <div className="mb-6">
              <Link href="/civilian-portal-hero">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-16 py-8 text-2xl font-bold shadow-xl backdrop-blur-sm border border-emerald-500/30"
                >
            ...
            {/* Tagline */}
            <div className="text-2xl font-bold text-green-400 mb-6">"No Life Too Far"</div>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-green-200 to-emerald-200 bg-clip-text text-transparent mb-4">
              Future Integrations
            </h2>
      ...
      <footer className="relative z-10 py-12 bg-black/40 backdrop-blur-sm border-t border-white/10">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-white via-green-200 to-emerald-200 bg-clip-text text-transparent mb-4">
              SafeRoute AI
            </h3>
