...
import { AlertTriangle, ClipboardCopy, ClipboardList, MapPin, Send, Shield, Stethoscope, Timer, User, FileText, Users } from 'lucide-react'
          ...
          <CardContent className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-2 text-xs text-slate-600 flex items-center gap-2">
                ...
                Live guided CPR to be added later; this console supports coordination now.
              </div>
              <div className="mt-2">
                <ComingSoonButton label="Open Live A/V" message="Live audio/video with consent is coming soon." />
              </div>
            </div>
